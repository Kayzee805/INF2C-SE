...
public class MockMessagingService implements MessagingService
{
    ...
    private String makeOpenedEventString(String toAddress, int lotNumber)
    {
        return toAddress + ": " + "Auction of lot " + Integer.toString(lotNumber) + " opened";
    }

    private String makeBidEventString(String toAddress, int lotNumber, Money amount)
    {
        return toAddress + ": " + amount + " bid on lot " + Integer.toString(lotNumber);
    }

    private String makeSoldEventString(String toAddress, int lotNumber)
    {
        return toAddress + ": " + "lot " + Integer.toString(lotNumber) + " has sold";
    }

    private String makeUnsoldEventString(String toAddress, int lotNumber)
    {
        return toAddress + ": lot " + Integer.toString(lotNumber) + " has not sold";
    }
    /*
