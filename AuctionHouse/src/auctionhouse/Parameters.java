...
public class Parameters
{
    ...
    public Parameters(double buyerPremium, double commission, Money increment,
            String houseBankAccount, String houseBankAuthCode, MessagingService messagingService,
