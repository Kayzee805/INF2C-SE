...
public class MockBankingService implements BankingService
{
    ...
    private String makeTransferEventString(String senderAccount, String senderAuthCode,
            String receiverAccount, Money amount)
    {

        return "From: " + senderAccount + " (" + senderAuthCode + ") To: " + receiverAccount
                + " Amount: " + amount;
     ...
     */
    public Status transfer(String senderAccount, String senderAuthCode, String receiverAccount,
            Money amount)
    {

        String s = makeTransferEventString(senderAccount, senderAuthCode, receiverAccount, amount);
    ...
    public void expectTransfer(String senderAccount, String senderAuthCode, String receiverAccount,
            Money amount)
    {

        expectedEvents.add(LS
                + makeTransferEventString(senderAccount, senderAuthCode, receiverAccount, amount));
